        ...
        <BookFeatured
          ...
          featuredText={
            <p className={`${cinzel.className} text-2xl`}>
              ...
              placeat temporibus dolore quisquam ratione laboriosam quam
              aspernatur tenetur illum cumque nostrum distinctio excepturi odit
              perferendis, nulla commodi quod alias doloremque?
              <Spacer y={3} />
