...
export const BookFeatured: React.FC<BookFeaturedProps> = ({
  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center bg-dark">
      <div
      ...
      />
      <div className="container mx-auto grid grid-cols-2 gap-5 px-3 py-10 pt-20 sm:p-20 xl:grid-cols-3 xl:gap-0">
